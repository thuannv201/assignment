  ...
  <body>
    <div class="col-10 offset-1">
      ...
      <table class="table table-strip mt-3">
        ...
        <tbody>
          <c:forEach items="${ nsxList }" var="nsx" varStatus="status">
            <tr>
              ...
              <td>
                <a
                  ...
                  href="${ pageContext.request.contextPath }/admin/cua-hang/detail?id=${ nsx.id }"
                  >Update</a
                >
              </td>
              <td>
                <button
                  ...
                  data-toggle="modal"
                  data-target="#delete_confirm_${ nsx.id }"
                >
                  Delete
                </button>
                <div
                  class="modal fade"
                  id="delete_confirm_${ nsx.id }"
                  tabindex="-1"
                  role="dialog"
                  aria-hidden="true"
                >
